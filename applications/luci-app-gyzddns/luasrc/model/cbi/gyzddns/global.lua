...
local a,t,e
local n={}
a=Map(i,translate("gyzddns"),translate("Guyezi DDNS Tool"))
a.template="gyzddns/index"
...
e.default=30
e.rmempty=false
t=a:section(TypedSection,"gyzddns",translate("Domain List"))
t.anonymous=true
t.addremove=true
t.template="cbi/tblsection"
t.extedit=o.build_url("admin","akddns","gyzddns","config","%s")
...
e.map.proceed=true
e.map:del(t)
luci.http.redirect(o.build_url("admin","akddns","gyzddns"))
end
local o=""
...
e.inputstyle="reload"
e.write=function()
luci.sys.call("/etc/init.d/gyzddns update")
luci.http.redirect(luci.dispatcher.build_url("admin","akddns","gyzddns"))
end
...
e.readonly=true
e.cfgvalue=function(t,t)
return s.readfile("/var/log/gyzddns.log")or""
end
